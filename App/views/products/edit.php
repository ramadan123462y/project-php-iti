...
<div class="pageContainer">
  ...
  <form action="<?= url('products/update/'.$product['id']) ?>" method="POST" enctype="multipart/form-data" class="mt-4">
  ...
  <div class="mb-3">
    ...
    <?php endif; ?>
    <img id="imagePreview" alt="<?= $product['name'] ?>" src="<?= url('assets/images/products/'. $product['image']) ?? '' ?>" style="<?php !$product['image'] ? 'display:none;' : 'display:block' ?> max-width:200px; margin-top:10px;">
